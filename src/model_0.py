...
def conceptual_model(snapshots=168):
    ...
    n.add("Link", "CHP+CCS",
            bus0="solid biomass", bus1="electricity", bus2="co2 atmosphere", bus3="co2 captured",
            efficiency=0.6, efficiency2=0.0345, efficiency3=0.1955,
